...
import '../widgets/rounded_button2.dart';
...
class _LoginScreenState extends State<TabLoginScreen> {
    ...
    if (res.statusCode == 200) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          ...
          backgroundColor:
              Color(0xFF08154A), // Set the background color to blue
        ),
      );
  ...
  User user2 = User(email: '', password: '');
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xFF08154A).withOpacity(0.8),
        centerTitle: true,
